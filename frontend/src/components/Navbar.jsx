                ...
                <div className="flex items-center space-x-6">
                    {user ? (
                        <>
                            ...
                            <button 
                                onClick={logout}
                                className="text-white px-6 py-2 rounded shadow-lg hover:to-indigo-500 hover:via-purple-500 hover:from-pink-500 flex items-center"
                            >
                                Logout
                            </button>
                        </>
                        ...
                        <>
                            <Link to="/login" className="hover:underline hover:text-indigo-200 transition-colors">
                                Login
                            </Link>
                            <Link 
                                to="/register" 
